<%-- 
    ...
    Created on : Sep 20, 2024, 4:44:57 AM
    Author     : 84941
--%>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-9 col-lg-7 col-xl-6 mt-5">
                    ...
                    <div class="bg-white rounded mt-2 mb-2">
                        ...
                        <!-- Form Section -->
                        <div class="pt-3 pb-3">
                            <form class="form-horizontal" action="${pageContext.request.contextPath}/ForgotPasswordController?service=resetPassword" method="post">
                                <!-- New Password Input -->
                                ...
                                <div class="form-group row justify-content-center">
                                    <div class="col-6">
                                        <input type="submit" name="ForgotPasswordEnterNewPasswordSubmit" value="Reset" class="btn btn-info btn-block">
                                    </div>
                                </div>
                            </form>
                        </div>
