<%-- 
    Document   : Sidebar
    Created on : Oct 8, 2024, 9:56:42 PM
    Author     : 84941
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/Sidebar.css"> <!-- Link to the external CSS file -->
    </head>
    ...
    <body>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="collapseDonHang">
                        <ul class="list-unstyled ps-3">
                            <li><a href="#" class="nav-link">Tạo đơn và giao hàng</a></li>
                            <li><a href="#" class="nav-link">Danh sách đơn hàng</a></li>
                            <li><a href="#" class="nav-link">Khách trả hàng</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="collapseSanPham">
                        <ul class="list-unstyled ps-3">
                            ...
                            <li><a href="#" class="nav-link">Quản lý kho</a></li>
                            <li><a href="#" class="nav-link">Đặt hàng nhập</a></li>
                            <li><a href="#" class="nav-link">Nhập hàng</a></li>
                            <li><a href="#" class="nav-link">Kiểm hàng</a></li>
                            <li><a href="#" class="nav-link">Chuyển hàng</a></li>
                            <li><a href="#" class="nav-link">Nhà cung cấp</a></li>
                            <li><a href="#" class="nav-link">Điều chỉnh giá vốn</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <!-- Khách hàng Section -->
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#collapseKhachHang" role="button"
                       aria-expanded="false" aria-controls="collapseKhachHang">
                        <i class="bi bi-people"></i>
                        <span class="menu-text">Khách hàng</span>
                        <i class="bi bi-caret-down-fill float-end"></i>
                    </a>
                    <div class="collapse" id="collapseKhachHang">
                        <ul class="list-unstyled ps-3">
                            <li><a href="#" class="nav-link">Danh sách khách hàng</a></li>
                            <li><a href="#" class="nav-link">Nhóm khách hàng</a></li>
                        </ul>
                    </div>
                </li>
            </ul>
